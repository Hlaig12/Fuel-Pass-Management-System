            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const Text('SMART FUEL PASS',
                      style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18)),
                  const SizedBox(height: 6),
                  const Text('FUEL DISPENSING RECEIPT',
                  ...
                  _Row('Quantity', '${result.litersDispensed.toStringAsFixed(1)} L'),
                  _Row('Price / Liter', _money(result.unitPrice, result.currency)),
                  _Row('Amount Paid', _money(result.amountPaid, result.currency), strong: true),
                  _Row('Quota Remaining', '${result.remainingAfter.toStringAsFixed(1)} L', strong: true),
